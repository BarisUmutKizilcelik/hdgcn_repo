...
if __name__ == '__main__':
    save_path = '/cvhci/temp/prgc/hdgcn_filtered/origin/no_noise'

    skes_path = '/cvhci/temp/prgc/filtered_skeletons'
    stat_path = osp.join(save_path, 'statistics')
    if not osp.exists('/cvhci/temp/prgc/hdgcn_filtered/origin/no_noise/raw_data'):
        os.makedirs('/cvhci/temp/prgc/hdgcn_filtered/origin/no_noise/raw_data')
