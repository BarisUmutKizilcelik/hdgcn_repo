...
if __name__ == '__main__':
    #/cvhci/temp/prgc/filtered_skeletons
    #'/cvhci/data/activity/NTU_RGBD/zipped/zipped_skeleton_csv/nturgb+d_skeletons'

    parser = argparse.ArgumentParser(description='NTU-RGB-D Data Converter.')
    parser.add_argument('--data_path',
                        default='/cvhci/temp/prgc/filtered_skeletons')
    parser.add_argument(
        '--ignored_sample_path',
        default=
        '/home/prgc/acrionreco-with-noisy-data-topic-c/HD-GCN/data/ntu120/statistics/samples_with_missing_skeletons.txt'
    )
    parser.add_argument('--out_folder', default='/cvhci/temp/prgc/hdgcn_filtered/filtered_gen_data')
