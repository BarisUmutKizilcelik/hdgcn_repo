...
def build_dataset_loader(params):
    ...
    data_path="/cvhci/temp/prgc/st-gcn/data/stgcn_filtered/xview/train_data.npy"
    label_path="/cvhci/temp/prgc/st-gcn/data/stgcn_filtered/xview/train_label.pkl"
    test_data_path="/cvhci/temp/prgc/st-gcn/data/stgcn_filtered/xview/val_data.npy"
    test_label_path="/cvhci/temp/prgc/st-gcn/data/stgcn_filtered/xview/val_label.pkl"
