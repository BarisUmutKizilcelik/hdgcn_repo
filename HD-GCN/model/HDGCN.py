...
from PNP.utils.module import MLPHead
import torch
...
class Model(nn.Module):
    def __init__(self, num_class=60, num_point=25, num_person=2, graph=None, graph_args=dict(), in_channels=3,
        ...
        self.proba_head = torch.nn.Sequential(
            MLPHead(base_channels*4, mlp_scale_factor=1, projection_size=3, init_method='He'),
            torch.nn.Sigmoid(),
        )
    ...
    def forward(self, x):
        ...
        return {'logits': self.fc(x), 'prob': self.proba_head(x)}